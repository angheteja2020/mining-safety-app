...
import { AlertTriangle, Search, Filter, X, Globe } from 'lucide-react';
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <button onClick={toggleSearch} title={isSearchVisible ? t.closeSearch : t.openSearch} style={{ background: 'rgb(243 244 246)', border: 'none', borderRadius: '50%', padding: '0.6rem', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
                {isSearchVisible ? <X color='rgb(107 114 128)' size={20} /> : <Search color='rgb(107 114 128)' size={20} />}
              </button>
            </div>
          </div>
          ...
          {filteredHazards.map((hazard, index) => (
            <div 
              ...
              style={{
                display: 'grid',
                gridTemplateColumns: '2.5fr 1fr 3fr',
                borderBottom: index === filteredHazards.length - 1 ? 'none' : '1px solid rgb(229 231 235)',
