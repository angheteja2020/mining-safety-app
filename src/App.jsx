...
function App() {
  ...
  const [checklistData, setChecklistData] = useState(() => {
    const saved = localStorage.getItem("hazardChecklists");
    return saved ? JSON.parse(saved) : {};
  });
  ...
  const filteredHazards = hazards.filter((hazard) => {
    const matchesSearch = hazard.name
      .toLowerCase()
  ...
  React.useEffect(() => {
    localStorage.setItem("hazardChecklists", JSON.stringify(checklistData));
  }, [checklistData]);
  ...
  const handleToggleCheck = (hazardId, controlType) => {
    setChecklistData((prev) => ({
      ...prev,
      [hazardId]: {
        ...(prev[hazardId] || {}),
        [controlType]: !(prev[hazardId]?.[controlType] || false),
      },
    }));
  };

  const getChecklistForHazard = (hazardId) => {
    return checklistData[hazardId] || {};
  };
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background:
          "linear-gradient(to bottom right, rgb(254 242 242), rgb(239 246 255))",
    ...
    >
      ...
      <header
        style={{
          background:
            "linear-gradient(to right, rgb(153 27 27), rgb(30 58 138))",
          color: "white",
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
            ...
            <div>
              <h1
                style={{ fontSize: "1.875rem", fontWeight: "bold", margin: 0 }}
              >
                {t.headerTitle}
              </h1>
              <p
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <button
                ...
                style={{
                  ...buttonStyle,
                  ...(filterType === "all" ? activeButtonStyle : {}),
                }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  ...(filterType === "administrative"
                    ? { ...activeButtonStyle, background: "rgb(153 27 27)" }
                    : { color: "rgb(153 27 27)" }),
                }}
              >
              ...
              <button
                ...
                style={{
                  ...buttonStyle,
                  ...(filterType === "ppe"
                    ? { ...activeButtonStyle, background: "rgb(21 128 61)" }
                    : { color: "rgb(21 128 61)" }),
                }}
              >
                {t.filterPpe}
            ...
            >
              ...
              >
                {isSearchVisible ? (
                  <ChevronUp color="rgb(107 114 128)" size={20} />
                ) : (
          ...
          >
            <strong>
              {t.resultsCounter
                .replace("{count}", filteredHazards.length)
                .replace("{total}", hazards.length)}
            </strong>
          </div>
        </div>
      </div>
        ...
        >
          ...
          <div
            style={{
              ...
              background:
                "linear-gradient(to right, rgb(185 28 28), rgb(30 64 175))",
              color: "white",
              fontWeight: "bold",
              fontSize: "1.125rem",
            }}
                ...
                <div
                  ...
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.background =
                      index % 2 === 0 ? "rgb(249 250 251)" : "white")
                  }
                >
                  {/* Hazard Name + Chevron */}
                  <div
                ...
                {expandedHazardId === hazard.id && (
                  <>
                    ...
                    <ChecklistSection
                      ...
                      checkedItems={getChecklistForHazard(hazard.id)}
