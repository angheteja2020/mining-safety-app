export const translations = {
  en: {
    ...
    // Footer
    footerText: 'Always follow safety protocols and report any hazards immediately.',
  ...
  es: {
    ...
    // Footer
    footerText: 'Siga siempre los protocolos de seguridad e informe de cualquier peligro inmediatamente.',
    ...
    hazards: [
      {
        ...
        controls: {
          ...
          administrative: "Zonas de exclusión y monitoreo visual regular del techo y las paredes."
        }
      },
      {
        id: 2,
        ...
        controls: {
          engineering: "Instalación de sistemas de advertencia de proximidad en vías clave para alertar a los trabajadores sobre la presencia de equipos en movimiento, incluyendo maquinaria de demostración.",
          administrative: "Vías peatonales claramente marcadas y pautas para visitantes, incluyendo áreas especiales para equipos de demostración."
        }
      },
      {
        id: 3,
        ...
        controls: {
          engineering: "Ventilación mecánica adecuada para diluir y eliminar contaminantes.",
          administrative: "Monitoreo regular de la calidad del aire (polvo, gases diésel, gases tóxicos, etc.)."
        }
      },
      {
        id: 4,
        ...
        controls: {
          administrative: "Mantenimiento y limpieza del área; formulario de informe de condiciones inseguras.",
      ...
      },
      {
        ...
        controls: {
          engineering: "Uso de interruptores de circuito por falla a tierra (GFCI) y asegurarse de que las cajas eléctricas estén cerradas y protegidas.",
          administrative: "Inspecciones regulares de cables y equipos eléctricos."
        }
      },
      {
        id: 6,
        name: "Incendio",
        controls: {
          engineering: "Extintores de incendios adecuados y debidamente señalizados en equipos móviles y en áreas clave.",
          administrative: "Prohibición de materiales inflamables no autorizados y plan de respuesta a emergencias."
        }
      },
      {
        id: 7,
        ...
        controls: {
          administrative: "Permisos de entrada para espacios confinados; prueba del entorno antes de entrar.",
      ...
      },
      {
        ...
        controls: {
          administrative: "Mantener las áreas de superficie despejadas y sin basura; capacitación sobre la fauna local y protocolos de respuesta.",
