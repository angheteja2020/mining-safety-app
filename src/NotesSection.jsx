...
function NotesSection({ hazardId, notes, onAddNote, onDeleteNote, onEditNote, t }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          <MessageSquare style={{ width: '1.25rem', height: '1.25rem', color: 'rgb(30 58 138)' }} />
          <h3 style={{ margin: 0, fontSize: '1.125rem', fontWeight: '600', color: 'rgb(31 41 55)' }}>
        ...
        {!isAdding && (
          <button
            ...
            onMouseEnter={(e) => e.currentTarget.style.background = 'rgb(30 64 175)'}
            onMouseLeave={(e) => e.currentTarget.style.background = 'rgb(30 58 138)'}
          >
                  ...
                  <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontSize: '0.75rem', color: 'rgb(107 114 128)', marginBottom: '0.25rem' }}>
                        <strong style={{ color: 'rgb(30 58 138)' }}>{note.author}</strong> {t.noteAdded} {formatDate(note.date)}
                      </div>
                      <p style={{ 
                        margin: 0, 
                        fontSize: '0.875rem', 
